...
Call log:
  - waiting for getByTestId('rs-async')
    - locator resolved to <div id="rs-async" data-async="true" data-mode="single" class="tta-rs is-open" data-testid="rs-async" data-searchable="true">…</div>
    - fill("Hyd")
                ...
                - generic [ref=e571]:
                  - generic [ref=e572]:
                    ...
                    - button "Remove Playwright" [ref=e574] [cursor=pointer]:
                      - img [ref=e575]
                  - generic [ref=e577]:
                    - generic [ref=e578]: Cucumber
                    - button "Remove Cucumber" [ref=e579] [cursor=pointer]:
                      - img [ref=e580]
              ...
              - generic [ref=e651]:
                - generic [ref=e652]:
                  - generic [ref=e653]:
                    ...
                    - textbox "Search cities" [active] [ref=e656]
                  - img [ref=e659]
                - listbox [ref=e661]:
                  - generic [ref=e662]: Type at least 2 characters…
              - generic [ref=e663]:
                - generic [ref=e664]:
                  - generic [ref=e665]: data-testid
                  - text: =rs-async · rs-async-input · rs-async-menu
                - generic [ref=e666]:
                  - generic [ref=e667]: state
                  - text: =loading / no-results / results
            - generic [ref=e668]: "{ \"rs-single\": \"Playwright\", \"rs-multi\": [ \"Playwright\", \"Cucumber\" ], \"rs-creatable\": [], \"rs-grouped\": null, \"rs-async\": null }"
          - complementary [ref=e669]:
            - generic [ref=e670]:
              - heading "What students should practise" [level=3] [ref=e671]
              - list [ref=e672]:
                - listitem [ref=e673]:
                  - text: Click
                  - code [ref=e674]: .tta-rs__control
                  - text: to open, then click
                  - code [ref=e675]: .tta-rs__option
                  - text: by visible text.
                - listitem [ref=e676]:
                  - text: Type into
                  - code [ref=e677]: .tta-rs__input-container input
                  - text: to filter options.
                - listitem [ref=e678]:
                  - text: "Multi: remove a chip via its"
                  - code [ref=e679]: .tta-rs__multi-value__remove
                  - text: button.
                - listitem [ref=e680]: "Creatable: type a brand-new value and press Enter; assert the chip appears."
                - listitem [ref=e681]:
                  - text: "Grouped: scope a query under a specific"
                  - code [ref=e682]: .tta-rs__group[data-group="Edge"]
                  - text: .
                - listitem [ref=e683]: "Async: wait for the loading notice to disappear, then click the result."
            - group [ref=e684]:
              - generic "Playwright solutions One snippet per variant. Show solution" [ref=e685] [cursor=pointer]:
                - img [ref=e687]
                - generic [ref=e689]:
                  - strong [ref=e690]: Playwright solutions
                  - generic [ref=e691]: One snippet per variant.
                - generic [ref=e692]: Show solution
```
...
```ts
  ...
  8  |     await page.getByRole("option", {name: "Playwright"}).click()
  9  | 
  10 |     await page.locator("#rs-multi").click()
  11 |     await page.getByRole("option", {name: "Playwright"}).click()
  12 |     await page.getByRole("option", {name: "Cucumber"}).click()
  13 |     await page.keyboard.press("Escape")
  14 | 
  15 |     await page.locator("#rs-async").click()
> 16 |     await page.getByTestId("rs-async").fill("Hyd")
     |                                        ^ Error: locator.fill: Error: Element is not an <input>, <textarea>, <select> or [contenteditable] and does not have a role allowing [aria-readonly]
  17 |     await expect(page.getByTestId('rs-async-menu')).toContainText('Hyderabad');
  18 |     await page.getByRole('option', { name: 'Hyderabad' }).click();
  19 | 
  20 | 
