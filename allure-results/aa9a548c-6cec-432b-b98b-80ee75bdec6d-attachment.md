...
```
Error: locator.click: Error: strict mode violation: getByText('Playwright') resolved to 15 elements:
    1) <span>Playwright fundamentals</span> aka getByRole('button', { name: 'Playwright fundamentals' })
    2) <span>Advance Playwright framework</span> aka getByRole('link', { name: 'Advance Playwright framework' })
    3) <span>Playwright API Testing</span> aka getByRole('button', { name: 'Playwright API Testing' })
    4) <span>Playwright BDD (Cucumber)</span> aka getByRole('button', { name: 'Playwright BDD (Cucumber)' })
    5) <span>Playwright DevOps</span> aka getByRole('button', { name: 'Playwright DevOps' })
    6) <span>Playwright AI</span> aka getByRole('button', { name: 'Playwright AI' })
    7) <span>Playwright MCP</span> aka getByRole('button', { name: 'Playwright MCP' })
    8) <span>Playwright CLI</span> aka getByRole('button', { name: 'Playwright CLI' })
    9) <span class="tta-rs__placeholder">Pick a Playwright runner…</span> aka getByText('Pick a Playwright runner…')
    10) <div role="option" class="tta-rs__option" data-value="Playwright">Playwright</div> aka getByRole('option', { name: 'Playwright' })
    ...
      ...
      - main [ref=e525]:
        ...
        - region "Select box variants workspace" [ref=e536]:
          - generic [ref=e537]:
              ...
              - generic [ref=e543]:
                - generic [ref=e544]:
                  - generic [ref=e545]:
                    ...
                    - textbox "Filter options" [active] [ref=e548]
                  - generic [ref=e549]:
                ...
                - listbox [ref=e557]:
                  - generic [ref=e558]:
                    - option "Playwright" [ref=e559] [cursor=pointer]
                    - option "Cypress" [ref=e560] [cursor=pointer]
                    - option "WebdriverIO" [ref=e561] [cursor=pointer]
                    - option "Selenium" [ref=e562] [cursor=pointer]
                    - option "TestCafe (deprecated)" [ref=e563]
                    - option "Puppeteer" [ref=e564] [cursor=pointer]
              - generic [ref=e565]:
                - generic [ref=e566]:
                  - generic [ref=e567]: id
                  - text: =rs-single
            ...
            - generic [ref=e572]:
              - generic [ref=e573]:
                - heading "② Multi — chips with remove" [level=2] [ref=e574]
                - generic [ref=e575]: Multiple values
              - paragraph [ref=e576]: Pick multiple options. Each becomes a removable chip with its own X button.
              - generic [ref=e578]:
                - generic [ref=e579]:
                  - generic [ref=e580]: Pick automation tools…
                  - textbox "Filter options" [ref=e582]
                - generic [ref=e583]:
                  - button "Clear values" [ref=e584] [cursor=pointer]:
                    - img [ref=e585]
                  - img [ref=e589]
              - generic [ref=e591]:
                - generic [ref=e592]:
                  - generic [ref=e593]: data-testid
                  - text: =rs-multi · rs-multi-input
                - generic [ref=e594]:
                  - generic [ref=e595]: chip
                  - text: =tta-rs__multi-value
                - generic [ref=e596]:
                  - generic [ref=e597]: remove
                  - text: =tta-rs__multi-value__remove
            - generic [ref=e598]:
              - generic [ref=e599]:
                - heading "③ Creatable multi — type and Enter" [level=2] [ref=e600]
                - generic [ref=e601]: Add new options
              - paragraph [ref=e602]:
              ...
              - generic [ref=e605]:
                - generic [ref=e606]:
                  - generic [ref=e607]: Add skill tags…
                  - textbox "Add a tag" [ref=e609]
                - generic [ref=e610]:
                  - button "Clear values" [ref=e611] [cursor=pointer]:
                    - img [ref=e612]
                  - img [ref=e616]
              - generic [ref=e618]:
                - generic [ref=e619]:
                  - generic [ref=e620]: data-testid
                  - text: =rs-creatable · rs-creatable-input
                - generic [ref=e621]:
                  - generic [ref=e622]: create
                  - text: =press Enter
            - generic [ref=e623]:
              - generic [ref=e624]:
                - heading "④ Grouped — categorised options" [level=2] [ref=e625]
                - generic [ref=e626]: Groups
              - paragraph [ref=e627]: Options are split into labelled groups. Practise reaching an option inside a specific group heading.
              - generic [ref=e629]:
                - generic [ref=e630]:
                  - generic [ref=e631]: Pick a deployment target…
                  - textbox "Filter options" [ref=e633]
                - img [ref=e637]
              - generic [ref=e639]:
                - generic [ref=e640]:
                  - generic [ref=e641]: data-testid
                  - text: =rs-grouped
                - generic [ref=e642]:
                  - generic [ref=e643]: group
                  - text: =tta-rs__group · data-group=Cloud / Edge / Self-hosted
            - generic [ref=e644]:
              - generic [ref=e645]:
                - heading "⑤ Async — fetched on type" [level=2] [ref=e646]
                - generic [ref=e647]: 600ms latency
              - paragraph [ref=e648]:
                - text: Type a city name. Results load after a simulated 600ms network call. Practise
                - code [ref=e649]: page.waitForResponse
                - text: patterns or just await a visible option.
              - generic [ref=e651]:
                - generic [ref=e652]:
                  - generic [ref=e653]: Type to search cities…
                  - textbox "Search cities" [ref=e655]
                - img [ref=e658]
              - generic [ref=e660]:
                - generic [ref=e661]:
                ...
                - generic [ref=e663]:
                  - generic [ref=e664]: state
                  - text: =loading / no-results / results
            - generic [ref=e665]: No selection yet — interact with the variants above.
          - complementary [ref=e666]:
            - generic [ref=e667]:
              - heading "What students should practise" [level=3] [ref=e668]
              - list [ref=e669]:
                - listitem [ref=e670]:
                  - text: Click
                  - code [ref=e671]: .tta-rs__control
                  - text: to open, then click
                  - code [ref=e672]: .tta-rs__option
                  - text: by visible text.
                - listitem [ref=e673]:
                  - text: Type into
                  - code [ref=e674]: .tta-rs__input-container input
                  - text: to filter options.
                - listitem [ref=e675]:
                  - text: "Multi: remove a chip via its"
                  - code [ref=e676]: .tta-rs__multi-value__remove
                  - text: button.
                - listitem [ref=e677]: "Creatable: type a brand-new value and press Enter; assert the chip appears."
                - listitem [ref=e678]:
                  - text: "Grouped: scope a query under a specific"
                  - code [ref=e679]: .tta-rs__group[data-group="Edge"]
                  - text: .
                - listitem [ref=e680]: "Async: wait for the loading notice to disappear, then click the result."
            - group [ref=e681]:
              - generic "Playwright solutions One snippet per variant. Show solution" [ref=e682] [cursor=pointer]:
                - img [ref=e684]
                - generic [ref=e686]:
                  - strong [ref=e687]: Playwright solutions
                  - generic [ref=e688]: One snippet per variant.
                - generic [ref=e689]: Show solution
```
...
> 8  |     await page.getByText("Playwright").click()
     |                                        ^ Error: locator.click: Error: strict mode violation: getByText('Playwright') resolved to 15 elements:
  9  | 
  10 |     
  11 | 
