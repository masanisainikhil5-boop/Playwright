...
- generic [ref=e1]:
  ...
  - dialog "Privacy" [ref=e73]:
    - generic [ref=e75]:
      ...
      - generic [ref=e80]:
        - button "Cookie Settings, Opens the preference center dialog" [active] [ref=e81] [cursor=pointer]: Cookie Settings
        - button "Allow Cookies" [ref=e82] [cursor=pointer]
    - button "Close" [ref=e84] [cursor=pointer]
  - alert [ref=e85]:
    - button "close banner" [ref=e86] [cursor=pointer]:
      - img [ref=e87]
    - generic [ref=e89]:
      - paragraph [ref=e90]: We have exciting news to share! VWO and AB Tasty are joining forces.
